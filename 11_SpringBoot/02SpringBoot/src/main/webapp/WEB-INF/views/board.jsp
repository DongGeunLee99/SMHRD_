	...
	<div class="container">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<button onclick = "location.href='${cpath}/goFile'" class="btn btn-primary" >파일 업로드</button>
				<button onclick = "location.href='${cpath}/goChat'" class="btn btn-primary" >채팅</button>
			</div>
		</div>
	</div>
</body>
